...
Сервис, который оценивает техническую чёткость и визуальные оси лица (свет, поза, линия челюсти), а сверху выдаёт мем-класс: "god / mogged / sigma / average / meh / trash". Подходит для селфи-проверки перед загрузкой, фильтрации брак-кадров и фанової аналитики.
...
- **Мем-лейбл**: rule-based или ML-классификатор по осям + эмбеддингу (CLIP/ArcFace): god / mogged / sigma / average / meh / trash
...
5. **Скоринг**: оси 0–100 + калибровка уверенности; правило или ML-классификатор выдаёт god/mogged/sigma/average/meh/trash
...
"FaceSharp оценивает чёткость и ключевые оси портрета, объясняет, как улучшить кадр, и — ради фана — присваивает мем-лейбл 'god / mogged / sigma / average / meh / trash'."
